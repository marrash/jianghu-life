(function(root){
  ...
  if(typeof module !== 'undefined') module.exports = require('./immortal.js')(require('./cultivation.js')(api));
  else root.Jianghu = root.JianghuImmortal(root.JianghuCultivation(api));
